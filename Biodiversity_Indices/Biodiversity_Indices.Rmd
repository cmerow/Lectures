...
```
  ...
  <div class="notes">
  - increaseing the number of replicates shows how each is unique, but a pattern emerges
...
- $N$ = total individuals
  ...
  - non parametric because they don't depend on partucular species abundance distribution (defined in a few slides)
...
<IMG STYLE="position:absolute; TOP:300px; LEFT:350px; WIDTH:600px; HEIGHT:360px" SRC="Figures/SDM_workflow.png">
...
The graph shows the relative abundance of species found in 4 sample communities. Which has the highest overall biodiversity, when truncating samples at 12 species? 
  ...
  - this highlights why rarefaction is important
...
## Spatial scales of diversity {.smaller}
  ...
  - Point diversity = species richness found in a plot sample.
      + Site A = 7 species
...
- How important is each aspect of diversity?
  ...
  - Your Question
    + ecosystem function is better described by dominant species or functional diversity
    + conservation might focus on rarity, richness
    + managing a population might focus on genetic diversity and abundance
    + natural resources might focus on phylogentic diversity or dominance
