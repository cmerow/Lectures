...
<!-- ---------------------------------------------------------------------------------- --> 
## Beyond Richness: Evenness {.smaller}
...
<IMG STYLE="position:absolute; TOP:350px; LEFT:240px; WIDTH:270px; HEIGHT:300px" SRC="Figures/RAD.png">
...
<IMG STYLE="position:absolute; TOP:50px; LEFT:700px; WIDTH:100px; HEIGHT:110px" SRC="Figures/RAD.png">
